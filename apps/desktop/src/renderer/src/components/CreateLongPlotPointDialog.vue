...
<template>
  <Teleport to="body">
    <div
      v-if="open"
      class="dialog-backdrop create-plot-point-overlay"
      @mousedown.self="close"
    >
      <section
        ref="dialogElement"
        class="create-plot-point-dialog"
        role="dialog"
        aria-modal="true"
        aria-labelledby="create-long-plot-point-title"
        tabindex="-1"
      >
...
<style scoped>
.create-plot-point-overlay {
  z-index: 2400;
  padding: 1rem;
}

.create-plot-point-dialog {
