...
export async function mutate<Result>(
  store: FolderCatalogStoreContext,operation: () => Promise<Result>): Promise<Result> {
...
export async function ensureRegistry(
  store: FolderCatalogStoreContext): Promise<FolderCatalogRegistry> {
...
export async function readRegistryOptional(
  store: FolderCatalogStoreContext): Promise<FolderCatalogRegistry | undefined> {
...
export async function writeRegistry(
  store: FolderCatalogStoreContext,registry: FolderCatalogRegistry): Promise<void> {
    await atomicWriteJson(
      store.registryPath,
      registry,
      store.maxManifestBytes
