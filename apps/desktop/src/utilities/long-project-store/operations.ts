...
import { assertDirectlyMutableDocument, validatePortableAndCanonicalPaths } from "./integrity";
import {
...
import { indexedFileSlots, requireIndexedFileReference, updateChapterBodyStatus } from "./paths";
